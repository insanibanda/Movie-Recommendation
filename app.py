...
# CONFIG
# =============================
API_BASE = "https://movrecommendation.onrender.com"
...
.stApp {
    background: radial-gradient(ellipse at top, #1a1a1a 0%, #0a0a0a 60%, #000000 100%);
    color: #f5f5f1;
}
...
h1 {
    ...
    letter-spacing: 2px;
    background: linear-gradient(90deg, #e50914, #ff5c5c, #e50914);
...
.small-muted { color:#9a9a9a; font-size: 0.92rem; }
...
div[data-testid="column"]:hover div[data-testid="stImage"] img {
...
.stSlider [data-baseweb="slider"] > div > div { background: #e50914 !important; }

hr { border-color: #2a2a2a !important; }

::-webkit-scrollbar { width: 10px; }
::-webkit-scrollbar-track { background: #0a0a0a; }
::-webkit-scrollbar-thumb { background: #e50914; border-radius: 6px; }
::-webkit-scrollbar-thumb:hover { background: #ff1a25; }
</style>
""",
